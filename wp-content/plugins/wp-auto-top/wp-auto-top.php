    ...
    <div class="wrap joychao-plugins">
        ...
        <form method="post">
            <table class="form-table" >
                ...
                <tr>
                    <td colspan="2">
                         <div style="height:100px; line-height:50px; border-top:1px dashed #ccc;border-bottom:1px dashed #ccc;font-size:22px;">
                           <div>
                             微博：
                             <a  style="text-decoration:none;" href="http://weibo.com/joychaocc" target="_blank">
                               <img src="http://www.sinaimg.cn/blog/developer/wiki/LOGO_32x32.png" style="vertical-align:-8px;"  />                         
                               @安正超
                             </a>
                           </div>
                           <!-- Baidu Button BEGIN -->                         
                           <div style="font-size:22px;height:50px; float:left; line-height:50px;">推荐给你的朋友们吧！</div>
                           <div id="bdshare" class="bdshare_t bds_tools_32 get-codes-bdshare" data="{'url':'http://www.joychao.cc/692.html'}">
                             <a class="bds_qzone"></a>
                             <a class="bds_tsina"></a>
                             <a class="bds_tqq"></a>
                        ...
                        <script type="text/javascript">
                          ...
                          var bds_config = {
                            ...
                            'bdComment':'非常理想的wordpress返回顶部插件',  //'请参考自定义分享评论'
                            'bdPic':'http://mystorage.qiniudn.com/wp-auto-top.jpg', //'请参考自定义分享出去的图片'
                            'searchPic':false,
                            'wbUid':'2.913182644',   //'请参考自定义微博 id'
                            'snsKey':{'tsina':'4000238328'}   //'请参考自定义分享到平台的appkey'
                          }
                          document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + new Date().getHours();
                          jQuery(function($){
                            $('select[name="autotop_comment_id_type"] option[value="<?php echo get_option('autotop_comment_id_type');?>"]').attr('selected',true);
                          })
                        </script>
                        <!-- Baidu Button END -->
                    </td>
